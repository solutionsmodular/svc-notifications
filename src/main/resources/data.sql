...
values (1, 'ORDER', 'CREATED', 'A', 'data.order.owner.email', 'STATIC', 'ORDER_PLACED_OWNER_EMAIL'),
       (1, 'ORDER', 'CREATED', 'A', 'data.order.owner.sponsor.email', 'STATIC', 'ORDER_PLACED_SPONSOR_EMAIL'),
       (1, 'ORDER', 'RETURNED', 'A', 'data.order.owner.email', 'STATIC', 'ORDER_RETURNED_OWNER_EMAIL'),
       (1, 'CAL_EVENT', 'RSVPED', 'A', 'data.order.owner.email', 'STATIC', 'CALEVENT_RSVPED_INVITEE_EMAIL'),
       (1, 'CAL_EVENT', 'STARTING', 'A', 'data.order.owner.email', 'STATIC', 'CALEVENT_STARTING_EMAIL'),
       (1, 'CAL_EVENT', 'ENDING', 'A', 'data.order.owner.email', 'STATIC', 'CALEVENT_ENDED_EMAIL')
;
